...
function Do(props) {
  return /*#__PURE__*/React.createElement("svg", _extends({
    ...
    d: "M211.862 132.69H8.828A8.829 8.829 0 0 1 0 123.862V9.103A8.829 8.829 0 0 1 8.828.275h203.034a8.829 8.829 0 0 1 8.828 8.828v114.759a8.829 8.829 0 0 1-8.828 8.828zm291.31 203.034H300.138a8.829 8.829 0 0 1-8.828-8.828V212.138a8.829 8.829 0 0 1 8.828-8.828h203.034a8.829 8.829 0 0 1 8.828 8.828v114.759a8.828 8.828 0 0 1-8.828 8.827z",
    fill: "#41479B"
  }), /*#__PURE__*/React.createElement("path", {
    ...
    d: "M255.772 192.149c2.237 0 6.147-.003 10.259-1.113-.917-.954-2.184-2.876-2.184-6.227 0-5.248 3.616-1.9 3.616-1.9s2.378 2.001.94 7.35a20.733 20.733 0 0 0 4.119-2.109c-.825-1.036-2.471-3.45-3.427-7.278 0 0 6.026-1.191 7.674 3.347a20.724 20.724 0 0 0 2.595-4.317c-1.549.019-3.71-1.003-3.71-6.901 0 0 3.935.007 4.988 3.42.414-1.427.729-2.956.961-4.572-1.571.456-5.633.783-5.633-8.032 0 0 4.877.009 6.006 4.329.062-1.105.086-2.247.075-3.425-2.368-1.238-5.636-3.965-5.297-9.56 0 0 2.249.51 4.311 2.239-.406-2.121-.238-5.226 3.015-7.817 0 0 2.989 5.29-1.377 9.585.38.534.711 1.142.984 1.817.981-1.494 2.554-2.883 5.088-3.727 0 0 1.166 7.085-5.449 10.049-.157 4.138-.804 7.794-1.916 10.973 1.895-1.669 3.428-3.967 3.428-3.967 0-7.872 6.453-8.071 6.453-8.071 1.205 8.985-5.439 9.348-5.439 9.348l-3.638 3.97c7.872-1.312 7.872 5.248 7.872 5.248-5.248 1.312-7.872-1.312-7.872-1.312l-2.838 1.459c5.034.147 6.774 5.101 6.774 5.101-6.327 1.055-10.953-.433-12.526-1.057-6.372 4.455-14.226 4.461-17.852 4.461v-1.311z"
  })), /*#__PURE__*/React.createElement("path", {
    d: "M233.863 134.955a44.99 44.99 0 0 0-11.958 11.167l4.224 3.115a39.747 39.747 0 0 1 10.551-9.856l-2.817-4.426z",
    fill: "#41479B"
  }), /*#__PURE__*/React.createElement("path", {
    d: "M256.014 169.066h18.367v10.496a5.247 5.247 0 0 1-5.248 5.248h-7.872c-2.156 0-4.052 1.054-5.248 2.66v-18.404h.001z",
    fill: "#FF6B71"
  }), /*#__PURE__*/React.createElement("path", {
    fill: "#5F64B9",
    ...
    d: "M256.014 169.066h-18.367v10.496a5.247 5.247 0 0 0 5.248 5.248h7.872c2.156 0 4.052 1.054 5.248 2.66v-18.404h-.001z",
    fill: "#FF6B71"
  }), /*#__PURE__*/React.createElement("path", {
    d: "M252.735 185.126a6.586 6.586 0 0 1 3.25 2.307h.061a6.59 6.59 0 0 1 3.25-2.307v-10.813h-6.56v10.813h-.001z",
    fill: "#F5F5F5"
  }), /*#__PURE__*/React.createElement("path", {
    fill: "#5F64B9",
    ...
    d: "M261.919 157.186v13.192a1.97 1.97 0 0 1-1.967 1.967h-7.872a1.97 1.97 0 0 1-1.967-1.967V157.24l-3.936-2.636v15.774a5.91 5.91 0 0 0 5.903 5.903h7.872a5.91 5.91 0 0 0 5.903-5.903v-15.863l-3.936 2.671z"
  }), /*#__PURE__*/React.createElement("path", {
    ...
    d: "M253.639 166.423a4.608 4.608 0 0 1 3.999-1.242l-2.07-6.664a4.616 4.616 0 0 0-3.999 1.242c.689 2.222 1.38 4.443 2.07 6.664z",
    fill: "#F5F0F0"
  }), /*#__PURE__*/React.createElement("path", {
    d: "M257.638 165.181a4.608 4.608 0 0 1 3.999-1.242l-2.07-6.664a4.616 4.616 0 0 0-3.999 1.242l2.07 6.664z",
    fill: "#F5F5F5"
  }), /*#__PURE__*/React.createElement("path", {
    d: "M250.022 136.354a39.786 39.786 0 0 0-20.37 5.07l-2.567-4.577a45.017 45.017 0 0 1 23.058-5.74c-.041 1.749-.082 3.498-.121 5.247z",
    fill: "#5F64B9"
  }), /*#__PURE__*/React.createElement("path", {
    d: "M278.167 134.955a44.99 44.99 0 0 1 11.958 11.167l-4.224 3.115a39.747 39.747 0 0 0-10.551-9.856l2.817-4.426z",
    fill: "#41479B"
  }), /*#__PURE__*/React.createElement("path", {
    d: "M262.008 136.354a39.786 39.786 0 0 1 20.37 5.07l2.567-4.577a45.017 45.017 0 0 0-23.058-5.74c.041 1.749.082 3.498.121 5.247z",
    fill: "#5F64B9"
  }), /*#__PURE__*/React.createElement("path", {
    d: "M266.51 134.955a39.767 39.767 0 0 0-20.991 0l-1.385-5.062a45.037 45.037 0 0 1 23.761 0l-1.385 5.062z",
    fill: "#41479B"
  }), /*#__PURE__*/React.createElement("path", {
    d: "M238.432 193.757a95.255 95.255 0 0 0-16.529 5.985l2.237 4.747a89.835 89.835 0 0 1 15.96-5.742l-1.668-4.99zm35.166 0a95.255 95.255 0 0 1 16.529 5.985l-2.237 4.747a89.835 89.835 0 0 0-15.96-5.742l1.668-4.99z",
    fill: "#FF6B71"
  }), /*#__PURE__*/React.createElement("g", {
    fill: "#FF4B55"
  }, /*#__PURE__*/React.createElement("path", {
    d: "M277.119 197.815a89.912 89.912 0 0 0-41.983 0l-1.225-5.102a95.168 95.168 0 0 1 44.433 0c-.407 1.7-.816 3.402-1.225 5.102z"
  }), /*#__PURE__*/React.createElement("path", {
    d: "M256.014 199.241l-3.618.905a1.312 1.312 0 0 1-1.63-1.272v-1.887c0-.853.802-1.48 1.63-1.272l3.618.905v2.621zm0-2.624l3.618-.905a1.312 1.312 0 0 1 1.63 1.272v1.887c0 .853-.802 1.48-1.63 1.272l-3.618-.905v-2.621z"
  })), /*#__PURE__*/React.createElement("path", {
    d: "M256.296 199.241h-.563a1.03 1.03 0 0 1-1.031-1.031v-.563a1.03 1.03 0 0 1 1.031-1.031h.563a1.03 1.03 0 0 1 1.031 1.031v.563a1.032 1.032 0 0 1-1.031 1.031z",
    fill: "#FF6B71"
  })));
}
