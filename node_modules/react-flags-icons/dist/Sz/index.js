...
function Sz(props) {
  return /*#__PURE__*/React.createElement("svg", _extends({
    ...
    d: "M0 273.931h512v52.966a8.829 8.829 0 0 1-8.828 8.828H8.828A8.829 8.829 0 0 1 0 326.897v-52.966zM8.828.276h494.345a8.829 8.829 0 0 1 8.828 8.828V62.07H0V9.103A8.828 8.828 0 0 1 8.828.276z",
    fill: "#4173CD"
  }), /*#__PURE__*/React.createElement("path", {
    fill: "#FF4B55",
    d: "M0 62.069h512v211.862H0z"
  }), /*#__PURE__*/React.createElement("path", {
    d: "M0 53.241h512v17.655H0zm0 211.862h512v17.655H0zm448.897-88.584H62.734a4.744 4.744 0 0 1-4.745-4.745v-1.501a4.744 4.744 0 0 1 4.745-4.745h386.163a4.744 4.744 0 0 1 4.745 4.745v1.501a4.745 4.745 0 0 1-4.745 4.745z",
    fill: "#FFE15A"
  }), /*#__PURE__*/React.createElement("path", {
    fill: "#F5F5F5",
    d: "M373.962 154.538l19.233-8.243 19.233 8.243-19.233 8.243z"
  }), /*#__PURE__*/React.createElement("path", {
    d: "M378.695 151.027H96.456a3.51 3.51 0 1 0 0 7.022h282.238a3.511 3.511 0 0 0 .001-7.022z",
    fill: "#FFE15A"
  }), /*#__PURE__*/React.createElement("path", {
    fill: "#F5F5F5",
    d: "M393.959 135.305l19.233-8.243 19.233 8.243-19.233 8.243z"
  }), /*#__PURE__*/React.createElement("path", {
    d: "M398.69 131.794H116.452a3.51 3.51 0 1 0 0 7.022H398.69a3.511 3.511 0 0 0 0-7.022z",
    fill: "#FFE15A"
  }), /*#__PURE__*/React.createElement("path", {
    ...
    d: "M441.633 185.618c-.352 0-.701-.163-.966-.482-4.31-5.199-9.8-6.866-9.853-6.884-.725-.213-1.169-1.084-.989-1.942.18-.852.915-1.385 1.636-1.172.254.075 6.27 1.886 11.136 7.755.524.627.515 1.647-.015 2.268a1.244 1.244 0 0 1-.949.457zm-3.102 12.128c-.405 0-.807-.213-1.074-.627-3.197-4.924-6.823-7.605-6.86-7.63-.638-.463-.833-1.453-.441-2.211.394-.751 1.227-.983 1.865-.52.167.119 4.088 3.026 7.584 8.407.455.702.344 1.71-.248 2.249a1.218 1.218 0 0 1-.826.332zm-7.105 13.499a1.05 1.05 0 0 1-.233-.025c-.735-.15-1.233-.978-1.106-1.848.534-3.671.087-9.691-.646-12.798-.201-.852.22-1.736.939-1.98.727-.232 1.468.263 1.668 1.116.828 3.508 1.312 10.055.708 14.201-.112.783-.685 1.334-1.33 1.334zm-9.523-14.809c-.386 0-.769-.194-1.036-.57-.481-.676-.409-1.692.161-2.261.034-.031 3.49-3.54 4.393-8.394.161-.864.878-1.409 1.613-1.221.729.188 1.193 1.046 1.032 1.911-1.106 5.939-5.122 9.992-5.294 10.161a1.242 1.242 0 0 1-.869.374zm-3.76-10.261c-.455 0-.899-.269-1.155-.765-.392-.751-.193-1.741.445-2.205.051-.038 4.961-3.652 6.484-7.598.309-.814 1.119-1.172 1.795-.796.68.37.979 1.322.669 2.124-1.869 4.842-7.302 8.833-7.531 9.002a1.19 1.19 0 0 1-.707.238z",
    fill: "#FF4B55"
  }), /*#__PURE__*/React.createElement("path", {
