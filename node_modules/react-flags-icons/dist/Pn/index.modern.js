...
function Pn(props) {
  return /*#__PURE__*/createElement("svg", _extends({
    ...
    d: "M387.206 89.365a.957.957 0 0 1-.575-.193c-.138-.106-13.838-10.783-5.769-28.879a.957.957 0 0 1 1.259-.482c.48.216.695.777.482 1.259-7.443 16.687 4.662 26.19 5.181 26.586a.95.95 0 0 1-.578 1.709z"
  }), /*#__PURE__*/createElement("path", {
    d: "M379.315 73.734a.953.953 0 0 1-.947-1.062c.396-3.422 1.683-5.81 3.828-7.096 3.449-2.073 7.76-.417 7.941-.344a.951.951 0 1 1-.694 1.772c-.038-.014-3.638-1.382-6.276.209-1.604.969-2.583 2.879-2.905 5.679a.956.956 0 0 1-.947.842zm2.587-12.274c-.082-.21-2.141-5.098-11.447-3.018-10.539 2.361-10.661 16.264-10.661 16.403a.953.953 0 0 0 1.872.242c3.928-14.962 18.557-12.449 19.178-12.34a.945.945 0 0 0 .907-.331.948.948 0 0 0 .151-.956z"
  }), /*#__PURE__*/createElement("path", {
    ...
    d: "M406.291 67.147s-5.054-.747-6.993-1.663c-1.613-.761-3.719-2.599-6.444-2.24a3.772 3.772 0 0 0-3.772 3.772c0 2.084 1.431 4.579 8.917 4.025 3.629-.269 6.721 1.389 6.721 1.389-.475-1.983 1.571-5.283 1.571-5.283z",
    fill: "#FF4B55"
  }), /*#__PURE__*/createElement("path", {
    ...
    d: "M368.364 106.424c-4.768 0-8.648-3.88-8.648-8.646 0-4.768 3.88-8.648 8.648-8.648 4.767 0 8.645 3.88 8.645 8.648.002 4.767-3.878 8.646-8.645 8.646zm0-14.437a5.798 5.798 0 0 0-5.791 5.791 5.797 5.797 0 0 0 5.791 5.79 5.795 5.795 0 0 0 5.79-5.79 5.796 5.796 0 0 0-5.79-5.791z",
    fill: "#9B8278"
  }), /*#__PURE__*/createElement("path", {
    ...
    d: "M329.377 248.245l-1.672-3.072a1.109 1.109 0 0 1 .444-1.503l3.051-1.658a1.107 1.107 0 0 1 1.502.444l1.672 3.072c.292.537.094 1.21-.444 1.503l-3.051 1.658a1.108 1.108 0 0 1-1.502-.444z",
    fill: "#FFCE5A"
  }), /*#__PURE__*/createElement("path", {
    ...
    d: "M433.374 248.245l1.672-3.072a1.109 1.109 0 0 0-.444-1.503l-3.051-1.658a1.107 1.107 0 0 0-1.502.444l-1.672 3.072a1.109 1.109 0 0 0 .444 1.503l3.051 1.658c.538.292 1.21.093 1.502-.444z",
    fill: "#FFCE5A"
  }), /*#__PURE__*/createElement("path", {
    d: "M343.289 161.016a3.81 3.81 0 0 0-3.809 3.809v41.896c0 11.426 3.809 53.322 41.896 68.557 38.088-15.235 41.896-57.131 41.896-68.557v-41.896a3.81 3.81 0 0 0-3.809-3.809h-76.174z",
    fill: "#4173CD"
  }), /*#__PURE__*/createElement("path", {
    d: "M379.067 161.016l-36.121 69.231a83.842 83.842 0 0 0 3.446 9.864l34.984-67.053 34.984 67.053a83.969 83.969 0 0 0 3.446-9.864l-36.121-69.231h-4.618z",
    fill: "#FFE15A"
  }), /*#__PURE__*/createElement("path", {
    ...
    d: "M395.539 244.451l2.304 1.105c-.966 1.428-2.977 3.738-6.823 5.831-2.905 1.581-5.713 3.452-7.741 4.885v-31.433l9.522-.979v-3.809l-9.522-.979v-4.734a1.905 1.905 0 0 0-1.905-1.905c-.897 0-1.614.633-1.816 1.469-.633-.454-1.367-.777-2.202-.777a3.871 3.871 0 0 0-3.866 3.866c0 1.003.407 1.9 1.037 2.589l-4.578.471v3.809l9.522.979v31.433c-2.027-1.433-4.835-3.305-7.741-4.885-3.847-2.092-5.857-4.403-6.823-5.831l2.304-1.105-8.689-11.069v15.235l2.929-1.405c1.159 1.867 3.608 4.881 8.46 7.519 4.059 2.209 7.998 5.079 9.559 6.254l1.905 1.476 1.905-1.476c1.561-1.175 5.501-4.045 9.559-6.254 4.852-2.638 7.301-5.652 8.46-7.519l2.929 1.405v-15.235l-8.689 11.069zm-18.183-25.496a1.963 1.963 0 0 1-1.962-1.962c0-1.082.879-1.962 1.962-1.962a1.963 1.963 0 0 1 0 3.924z",
    fill: "#FFE15A"
  }), /*#__PURE__*/createElement("path", {
    d: "M384.318 210.53h-5.885a2.77 2.77 0 0 1-2.771-2.771v-9.694a2.77 2.77 0 0 1 2.771-2.771h5.885a2.77 2.77 0 0 1 2.771 2.771v9.694a2.77 2.77 0 0 1-2.771 2.771z",
    fill: "#F5F5F5"
  }), /*#__PURE__*/createElement("path", {
